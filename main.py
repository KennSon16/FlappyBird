...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom = (576, random_pipe_pos - 300))
...
def draw_pipes(pipes):
    for pipe in pipes:
        if pipe.bottom >= 1024:
            ...
            flip_pipe = pygame.transform.flip(pipe_surface, False, True) # (the image, x ,y)
...
game_over_surface = pygame.transform.scale2x(pygame.image.load('flappy-bird-assets-master/sprites/message.png').convert_alpha())
game_over_rect = game_over_surface.get_rect(center = (288, 512))

flap_sound = pygame.mixer.Sound('flappy-bird-assets-master/audio/wing.wav')
death_sound = pygame.mixer.Sound('flappy-bird-assets-master/audio/hit.wav')
score_sound = pygame.mixer.Sound('flappy-bird-assets-master/audio/point.wav')

score_sound_countdown = 6500
while True:
